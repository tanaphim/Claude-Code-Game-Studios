...
>
> **Coverage:** 53 criteria — Core Rules 15 + 4 (R3.1, R12 atomicity, R12 CAS,
...
> split into a/b/c per Cluster 3 #7 + qa-1 ; TR-042 mid-range overflow) +
> 1 (TR-055 ghost-slot accounting per Cluster 3 #8)**, Manual 2 + 1
