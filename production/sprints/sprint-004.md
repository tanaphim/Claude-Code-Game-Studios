...
| **S4-09 AI Bot item-buying (2.0d)** | Deferred 2026-05-08 by user. Must Have ปิดครบ 8/8; S4-09 เป็น first real feature implementation (design + C# code + playtest) ใน Sprint นี้ — แตกต่างจาก doc/investigation theme. ปิด Sprint 004 สะอาดดีกว่า rush. R-21 entanglement (Role Restriction unimplemented) ต้องตัดสินใจก่อน design item priority list |
| **S4-10 AI Bot Difficulty (1.0d)** | Deferred 2026-05-08 — depends S4-09 |
...
- **2026-05-08** — **Sprint 004 Must Have CLOSED 8/8 ✅**. S4-09 + S4-10
  (Should Have, AI Bot batch) deferred to Sprint 005+ by user decision
  (avoid rush on first real feature implementation; let R-21 Role
  Restriction decision land first). Sprint 004 ends with
  documentation/investigation theme intact; ready for retrospective +
  Sprint 005 (Phase 2 Hercules pilot) planning.
