...
| **S6-03** | **Phase 3 hero #1 — Horus migration** (BUG-0001 cousin: HorusE/HorusR verification). [Story](../epics/phase-3-hero-migration/S6-03-horus-migration.md) | gameplay-programmer | `tanapol` | 0.5 | S6-01, S6-02; Phase 2 soak green | Hero playable; 0 BindSlot/slot=0 warnings; multipeer Pass #1-5; BUG-0001 cousin verdict recorded |
| **S6-04** | **Phase 3 hero #2 — Volund migration** (BUG-0001 cousin: VolundW; largest action file 118 lines). [Story](../epics/phase-3-hero-migration/S6-04-volund-migration.md) | gameplay-programmer | `tanapol` | 0.5 | S6-03 | Same as S6-03 + VolundW pattern surface check |
| **S6-05** | **Phase 3 hero #3 — Guan Yu migration** (BUG-0001 cousin: GuanYuE; 6 abilities + W/R sub-systems). [Story](../epics/phase-3-hero-migration/S6-05-guanyu-migration.md) | gameplay-programmer | `tanapol` | 0.5 | S6-04 | Same + companion file audit + GuanYu N-action TD-006 cousin guard |
| **S6-06** | **Phase 3 hero #4 — Skadi migration (control case)** — clean baseline, no BUG-0001/R-23/special variants; smallest LOC. [Story](../epics/phase-3-hero-migration/S6-06-skadi-migration.md) | gameplay-programmer | `tanapol` | 0.5 | S6-05 | Same + velocity baseline note for batch 2 estimation |
